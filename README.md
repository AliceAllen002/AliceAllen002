...
## Objective
My journey in computer science has led me to develop a passion for cybersecurity, and I am now eager to transition into this field, specifically aiming to join a Offensive Security Certified Professional (OSCP), however I also looking to get hand on the Security Operations Center (SOC) as a Tier 1 Analyst.

## Skills

| Skill                                         | Associated Project         |
|-----------------------------------------------|----------------------------|
|BASH Scripting with Linux & BlueTeam  | <a href="https://google.com">Detection Lab</a>|
